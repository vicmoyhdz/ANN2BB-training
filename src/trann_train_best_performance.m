function [varargout] = trann_train_best_performance(varargin)
    ...
    saveas(gcf,fullfile(wd,strcat(dsg.fnm,'_all_prf_',num2str(dsg.nhn),'n_',dbn_name,'_',verNet)),'jpeg');
    close(gcf);
    ...
    saveas(gcf,fullfile(wd,strcat(dsg.fnm,'_all_r_',num2str(dsg.nhn),'n_',dbn_name,'_',verNet)),'jpeg');
    close(gcf);
    ...
    fpplot('xpl',{(1:dsg.ntr)';bst.idx},...
        ...
        'lst',{'none';'none'},'lwd',[0.1;0.1],'mrk',{'o';'x'});
    saveas(gcf,fullfile(wd,strcat(dsg.fnm,'_all_mae_',num2str(dsg.nhn),'n_',dbn_name,'_',verNet)),'jpeg');
    close(gcf);
    ...
    fpplot('xpl',{ann.trs.TrainingHistory.Iteration';ann.trs.ValidationHistory.Iteration;...
        ...
        'lst',{'-';'--';':';'-';'-'},'lwd',[1;1;1;1;1]);
    saveas(gcf,fullfile(wd,strcat(dsg.fnm,'_bst_prf_',num2str(dsg.nhn),'n_',dbn_name,'_',verNet)),'jpeg');
    close(gcf);
